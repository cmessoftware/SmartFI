  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.code === 'ECONNABORTED') {
        setError('El servidor no respondió a tiempo. ¿Está corriendo el backend en el puerto 8000?');
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-finly-primary focus:border-transparent pr-12"
                placeholder="••••••••"
                required
              />
              <button
