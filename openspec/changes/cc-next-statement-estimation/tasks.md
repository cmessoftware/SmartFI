...
- [ ] 2.2 Mostrar saldo anterior neto luego de restar pagos proyectados.
...
- [ ] 4.4 Verificar escenario: CSV con intereses/impuestos agrega solo esos cargos.
- [ ] 4.5 Verificar escenario: CSV con `SU PAGO EN PESOS` ya proyectado no duplica el movimiento.