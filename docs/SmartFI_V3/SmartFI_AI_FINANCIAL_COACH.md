...
SmaartFI V1 es un asistente inteligene para gestión de finanzas peronales. Te permite
 ...
 - Dashboard simples
 - Soporta carga masivas desde csv, download de resumens en csv.
 - Se conecta a google shseet para exportar la info.
